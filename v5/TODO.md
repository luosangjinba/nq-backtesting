...
- Next recommended step: Move to replay control persistence/polish or an audit
  of remaining FXReplay parity gaps. Multi-pane cadence or pane update-order
  audits can stay optional unless manual testing exposes a user-visible
  regression.
