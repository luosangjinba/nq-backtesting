...
Phase A1 accepted the real NQ/ES data contract: DuckDB and V4 API timestamps are
exchange wall-clock fields encoded as UTC-like epoch seconds; ordinary source
