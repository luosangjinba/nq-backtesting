...
assert.equal(paneReloadChartData.includes('CHART_DATA_PROJECTION_COMMANDS'), false);
...
assert.match(
  ...
  'Step 194 must not route pane reload replacement through projection owner yet.',
);
