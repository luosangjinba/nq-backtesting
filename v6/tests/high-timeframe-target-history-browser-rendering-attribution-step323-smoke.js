  ...
  records: [
    {
      browserVisible: true,
      path: 'target-history',
      postLeftExtensionReadoutMs: 430,
      postLeftExtensionSecondFrameMs: 450,
    ...
    },
    {
      browserVisible: true,
      path: 'target-history',
      postLeftExtensionReadoutMs: 440,
      postLeftExtensionSecondFrameMs: 460,
    ...
    },
    {
      browserVisible: true,
      path: 'target-history',
      postLeftExtensionReadoutMs: 420,
