...
assert.equal(VALIDATION_DATABASE_VERSION, 4);
...
assert.deepEqual(upgradedStores.sort(), ['validationEvidence', 'validationExecutions', 'validationObservations', 'validationOutcomes', 'validationTradePlanRevisions']);
