...
async function main() {
  ...
  try {
    ...
    assert.equal(value.registrySnapshot.started.includes('runtime.loaded-window-date-locator'), true);
    ...
    assert.equal(value.commands.includes('loadedWindowDateLocator.locate'), true);
