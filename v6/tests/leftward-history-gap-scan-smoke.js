...
assert.equal(state.extension.plannedWindow.start, '2026-06-01 09:24');
assert.equal(state.extension.plannedWindow.end, '2026-06-01 09:26');
...
console.log('v6 leftward history gap scan smoke passed');
