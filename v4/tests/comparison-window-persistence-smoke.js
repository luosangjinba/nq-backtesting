...
updateComparisonVisibleWindow({ x: 0, y: 0, width: 34, height: 100 });
...
assert.deepEqual(sanitized.descriptor.visibleWindow, { x: 0, y: 0, width: 34, height: 100 });
...
const legacyFloating = serializeComparisonWorkspaceState({
  enabled: true,
  descriptor: {
    layoutMode: 'floating',
