...
- [ ] Step 326: Post-clear Sliding Comparison validation。Clear 后优先接驳 `v4/sessions/session_20260622_clear_handoff.md`，确认最新提交至少为 `fd27de3`，然后验证左侧 Comparison / 右侧 Main 是否在真实浏览器中生效；若仍显示旧形态，先检查静态服务/浏览器缓存是否加载旧 bundle，再检查 localStorage workspace。
