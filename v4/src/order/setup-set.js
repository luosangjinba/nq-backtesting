...
export function createSetupSetFromOrderReview(order) {
  ...
  return {
    ...
    sourceId: order.id,
    sourceChartId: order.sourceChartId || 'legacy-shared',
    sourceChartLabel: order.sourceChartLabel || '',
    sourceInstrument: order.sourceInstrument || order.instrument || '',
    sourceTimeframe: order.sourceTimeframe ?? null,
    sourceTimeframeLabel: order.sourceTimeframeLabel || '',
    sourceContext: order.sourceContext || '',
