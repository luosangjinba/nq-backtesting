...
import {
  getDailyTimeDetailSection,
  getDailyTimeLocateRange,
  getDailyTimeSectionName,
  getDailyTimeTargetFromElement,
  getDailyTimeTargetKey,
  getDailyTimeTargetLabel,
  getDailyTimeTargetTime,
} from './time-reaction-targets.js';
