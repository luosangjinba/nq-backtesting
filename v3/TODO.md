...
**创建时间**：2026-05-15  
**预计时长**：3-4 天  
**计划文档**：`v3/docs/CHART_DISPLAY_CONTROL_PLAN.md`

#### 功能 1：K 线回放（Replay）- 1.5 天
**状态**：⏸ 待开始
...
- [ ] 创建 PDA 控制面板 UI
- [ ] 实现按类型显示/隐藏（BSL/SSL/FVG/NWOG/NDOG/Daily H/L/ICT Midnight H/L/EQH/EQL）
- [ ] 实现全选/全不选
- [ ] 实现按周期显示/隐藏（1M/5M/15M/1H/4H/D/W）
- [ ] 实现多周期叠加
- [ ] 实现周期切换时 PDA 保持
- [ ] 实现按时间范围过滤
