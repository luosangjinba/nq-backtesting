...
- Focused R13.10a–R13.10d, P0a, Replay Workspace UI/composition, Annotation
  ...
  matrix.
- Current production source evidence is 499 files, 44,187 effective lines, 4,604 functions, and 462 public exports, with no source-size/function exception or validation finding.
