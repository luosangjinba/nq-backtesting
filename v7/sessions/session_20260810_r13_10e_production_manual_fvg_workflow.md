...
- Focused R13.10a–R13.10d, P0a, Replay Workspace UI/composition, Annotation
  ...
  matrix.
- Current production source evidence is 485 files, 42,009 effective lines, 4,354 functions, and 452 public exports, with no source-size/function exception or validation finding.
