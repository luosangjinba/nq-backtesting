...
- Focused R13.10a–R13.10d, P0a, Replay Workspace UI/composition, Annotation
  ...
  matrix.
- Current production source evidence is 534 files, 48,655 effective lines, 5,109 functions, and 519 public exports, with no source-size/function exception or validation finding.
