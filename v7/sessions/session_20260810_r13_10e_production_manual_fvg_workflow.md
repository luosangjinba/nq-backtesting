...
- Focused R13.10a–R13.10d, P0a, Replay Workspace UI/composition, Annotation
  ...
  matrix.
- Current production source evidence is 497 files, 43,718 effective lines, 4,546 functions, and 461 public exports, with no source-size/function exception or validation finding.
