...
- Focused R13.10a–R13.10d, P0a, Replay Workspace UI/composition, Annotation
  ...
  matrix.
- Current production source evidence is 467 files, 39,300 effective lines, 4,115 functions, and 434 public exports, with no source-size/function exception or validation finding.
