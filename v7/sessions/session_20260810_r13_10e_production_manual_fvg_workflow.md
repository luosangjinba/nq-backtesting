...
- Focused R13.10a–R13.10d, P0a, Replay Workspace UI/composition, Annotation
  ...
  matrix.
- Current production source evidence is 642 files, 60,099 effective lines, 6,155 functions, and 650 public exports, with no source-size/function exception or validation finding.
