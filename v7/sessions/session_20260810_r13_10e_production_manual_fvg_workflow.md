...
- Focused R13.10a–R13.10d, P0a, Replay Workspace UI/composition, Annotation
  ...
  matrix.
- Current production source evidence is 516 files, 46,189 effective lines, 4,794 functions, and 507 public exports, with no source-size/function exception or validation finding.
