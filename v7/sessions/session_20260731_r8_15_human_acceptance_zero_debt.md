...
- production architecture: 51 modules, 127 edges, 115 construction sites,
  19 writers, zero findings;
- production source: 319 files, 24,940 effective lines, 2,640 functions, 311
