...
- [x] keep the canonical unresolved-product/architecture memo registry on
  `main`, independent of any feature-branch lifecycle;
- [x] assign stable `MEMO-V7-###` ids, first-formed dates, last substantive
  revision timestamps, current status, and stable source paths;
...
- [x] record explicit tensions among the plugin-platform, seconds/tick,
  Agent-participatory learning-system, and branch-local Drawing/Semantic
