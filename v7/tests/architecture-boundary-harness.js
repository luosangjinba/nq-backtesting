...
assert.deepEqual(manifest.writerInventories, {
  ...
  localPluginPackageInventory: ['core.plugin-package-store'],
  localPluginPackageStorage: ['adapter.plugin-package-storage'],
  replayNavigationPreferences: ['core.replay-navigation-preference-store'],
  workstationSettings: ['core.workstation-settings'],
  corePluginProfile: ['core.plugin-profile'],
  calculatedSeriesDocument: ['optional.calculated-series-runtime'],
  calculatedSeriesDocumentStorage: ['adapter.calculated-series-persistence'],
  calculatedSeriesDom: ['optional.calculated-series-ui'],
  validationCampaignDocument: ['optional.validation-campaign-runtime'],
  validationCampaignStorage: ['adapter.validation-campaign-persistence'],
  validationCampaignDom: ['adapter.validation-campaign-ui'],
  ...
  pluginCenterDom: ['adapter.plugin-center-ui'],
