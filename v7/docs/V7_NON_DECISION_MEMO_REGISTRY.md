...
| --- | --- | --- | --- | --- | --- |
| `ADR-V7-001` / `R13.1` | Drawing and Semantic Annotation foundation | 2026-08-07 | accepted 2026-08-08; R13.2 Geometry contract implemented separately | narrows annotation terminology and state ownership discussed broadly by MEMO-V7-001; supplies the candidate evidence substrate for MEMO-V7-003 | `V7_DRAWING_AND_SEMANTIC_ANNOTATION_FOUNDATION_R13_1.md` |
